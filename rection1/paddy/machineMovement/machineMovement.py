...
class machineMovement:
    ...
    def search_turning_position(self, target_position, val_add_flag):
        ...
        if self.row_flag:
            ...
            if val_add_flag:
                ...
                while self.is_position_in_polygon([next_x_position, next_y_position]):
                    ...
                    first_target_position = [now_x_position, next_y_position]
            # 下から上に進行
            else:
                next_x_position = now_x_position + 1
                next_y_position = now_y_position - 1
            ...
            # 列を変更
            second_target_position = [first_target_position[0] + 1, first_target_position[1]]
        # 行に向かっている
        # 横に進行
        else:
            ...
            if val_add_flag:
                ...
                while self.is_position_in_polygon([next_x_position, next_y_position]):
                    ...
                    first_target_position = [next_x_position, now_y_position]
            # 右から左に進行する
            else:
                next_x_position = now_x_position - 1
                next_y_position = now_y_position + 1
                ...
                # 右から左に進行する
                    ...
                    first_target_position = [next_x_position, now_y_position]
            # 列を変更
            second_target_position = [first_target_position[0], first_target_position[1] + 1]
        return first_target_position, second_target_position
